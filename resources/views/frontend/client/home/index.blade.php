            ...
            <div class="col-lg-8">
                <div class="instagram__pic">
                    <div class="instagram__pic__item set-bg"
                        data-setbg="{{ asset('frontend/img/instagram/insta') }}gram-1.jpg"></div>
                    <div class="instagram__pic__item set-bg"
                        data-setbg="{{ asset('frontend/img/instagram/insta') }}gram-2.jpg"></div>
                    <div class="instagram__pic__item set-bg"
                        data-setbg="{{ asset('frontend/img/instagram/insta') }}gram-3.jpg"></div>
                    <div class="instagram__pic__item set-bg"
                        data-setbg="{{ asset('frontend/img/instagram/insta') }}gram-4.jpg"></div>
                    <div class="instagram__pic__item set-bg"
                        data-setbg="{{ asset('frontend/img/instagram/insta') }}gram-5.jpg"></div>
                    <div class="instagram__pic__item set-bg"
                        data-setbg="{{ asset('frontend/img/instagram/insta') }}gram-6.jpg"></div>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="blog__item">
                    <div class="blog__item__pic set-bg" data-setbg="{{ asset('frontend/img/blog/blog-1.jpg') }}">
                    </div>
