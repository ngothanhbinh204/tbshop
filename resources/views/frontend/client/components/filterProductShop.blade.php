<div class="col-lg-3">
    <form action="" method="GET">
        <div class="shop__sidebar">
                                    ...
                                    <ul>
                                        ...
                                        @if (isset($brands))
                                            ...
                                            @foreach ($brands as $brand)
                                                <li>
                                                    <a
                                                        href="{{ route('client.brand.index', $brand_id = $brand->id) }}">
                                ...
                                <div class="shop__sidebar__color">
                                    @if (isset($colors))
                                        @foreach ($colors as $color)
                                            <input type="checkbox" name="color" id="" value="{{ $color->value }}">
            ...
            <button class="btn-primary" type="submit" name="filter"> Lọc Ngay  </button>
        </div>
    </form>
</div>
