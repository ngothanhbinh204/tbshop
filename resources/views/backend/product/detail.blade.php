                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="m-t-md">
                                <h2 class="product-main-price">$406,602 <small class="text-muted">Exclude Tax</small>
                                </h2>
                            </div>
                            <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div>
                                ...
                                <h1 class="product-main-price">$406,602 <small class="text-muted">Exclude Tax</small>
                                </h1>
                            </div>
                            <hr>
                            <h4>Product description</h4>
