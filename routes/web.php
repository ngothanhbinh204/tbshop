...
/*FRONTEND ROUTES */
Route::group(['middleware' => 'preventBackToLogin'], function () {
    /* AJAX FRONTEND */
    ...
    Route::group(['prefix' => 'account'], function () {
        ...
        Route::group(['middleware' => 'user.profile'], function () {
            ...
            Route::post('/profile', [AccountController::class, 'post_profile'])->name('account.profile_update');

            Route::get('/change-password', [AccountController::class, 'change_password'])->name('account.change_password');
            Route::post('/change-password', [AccountController::class, 'post_change_password'])->name('account.post_change_password');
        });

        Route::get('/forgot-password', [AccountController::class, 'forgot_password'])->name('account.forgot');
        Route::post('/forgot-password', [AccountController::class, 'post_forgot_password'])->name('account.post_forgot');

        Route::get('/reset-password/{user}/{token}', [AccountController::class, 'reset_password'])->name('account.reset_password');
        Route::post('/reset-password', [AccountController::class, 'post_reset_password'])->name('account.post_reset_password');
    });
    ...
    Route::post('onepay_payment', [CheckoutController::class, 'onepay_payment'])->name('onepay_payment');
});
...
Route::group(['prefix' => 'gallery'], function () {
    Route::get('/add/{product_id}', [GalleryController::class, 'addGallery'])->name('admin.gallery.add');
    Route::post('/select-gallery', [GalleryController::class, 'selectGallery'])->name('admin.gallery.select');
    Route::post('/insert-gallery/{pro_id}', [GalleryController::class, 'insertGallery'])->name('admin.gallery.insert');
    Route::post('/update-gallery-image', [GalleryController::class, 'updateGalleryImage'])->name('admin.gallery.update_image');
    Route::post('/update-gallery-name', [GalleryController::class, 'updateGalleryName'])->name('admin.gallery.update_name');
    Route::post('/delete-gallery', [GalleryController::class, 'deleteGallery'])->name('admin.gallery.delete');
});
/* CATEGORIES */
